...
def generate_multiple_problems(
    ...
    :param total_num_problems: the amount of problems to create
    :param num_prev_instances: the problem index to start from
    """
    for i in range(num_prev_instances, num_prev_instances + total_num_problems):
